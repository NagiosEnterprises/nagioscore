...
int pre_flight_object_check(int *w, int *e) {
	...
	for(temp_hostgroup = hostgroup_list ? hostgroup_list[0] : NULL, total_objects = 0; temp_hostgroup != NULL; temp_hostgroup = temp_hostgroup->next, total_objects++) {
	...
	for(temp_servicegroup = servicegroup_list ? servicegroup_list[0] : NULL, total_objects = 0; temp_servicegroup != NULL; temp_servicegroup = temp_servicegroup->next, total_objects++) {
	...
	for(temp_contact = contact_list ? contact_list[0] : NULL, total_objects = 0; temp_contact != NULL; temp_contact = temp_contact->next, total_objects++) {
	...
	for(temp_contactgroup = contactgroup_list ? contactgroup_list[0] : NULL, total_objects = 0; temp_contactgroup != NULL; temp_contactgroup = temp_contactgroup->next, total_objects++) {
	...
	for(temp_command = command_list ? command_list[0] : NULL, total_objects = 0; temp_command != NULL; temp_command = temp_command->next, total_objects++) {
	...
	for(temp_timeperiod = timeperiod_list ? timeperiod_list[0] : NULL, total_objects = 0; temp_timeperiod != NULL; temp_timeperiod = temp_timeperiod->next, total_objects++) {
