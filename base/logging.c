...
int log_debug_info(int level, int verbosity, const char *fmt, ...) {
	...
	fprintf(debug_file_fp, "[%llu.%06llu] [%03d.%d] [pid=%lu] ", (unsigned long long)current_time.tv_sec, (unsigned long long)current_time.tv_usec, level, verbosity, (unsigned long)getpid());
