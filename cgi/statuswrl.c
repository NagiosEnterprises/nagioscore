...
void draw_host_links(void) {
	...
	for(child_host = host_list ? host_list[0] : NULL; child_host != NULL; child_host = child_host->next) {
		...
		for(parent_host = host_list ? host_list[0] : NULL; parent_host != NULL; parent_host = parent_host->next) {
