...
int add_new_comment(int,char *,char *,time_t,char *,char *,int,int,int *);       /* adds a new host or service comment */
int add_new_host_comment(char *,time_t,char *,char *,int,int,int *);             /* adds a new host comment */
int add_new_service_comment(char *,char *,time_t,char *,char *,int,int,int *);   /* adds a new ervice comment */
...
int add_comment(int,char *,char *,time_t,char *,char *,int,int,int);      /* adds a comment (host or service) */
int add_host_comment(char *,time_t,char *,char *,int,int,int);            /* adds a host comment */
int add_service_comment(char *,char *,time_t,char *,char *,int,int,int);  /* adds a service comment */
