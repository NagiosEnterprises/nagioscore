...
# define AU_STATE_DOWNTIME_START		(1<<9)
											/* Downtime start */
...
extern int	au_add_alert_or_state_log(au_log *, time_t, int, int, void *, int, int, char *);
extern au_log_alert *au_create_alert_or_state_log(int, void *, int, int, char *);
