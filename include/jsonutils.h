...
extern json_object *json_result(time_t, int, char *, ...);
...
extern int parse_bitmask_cgivar(json_object *, time_t, char *, char *, 
		string_value_mapping *, unsigned *);
extern int parse_enumeration_cgivar(json_object *, time_t, char *, char *, 
		string_value_mapping *, int *);
extern int parse_string_cgivar(json_object *, time_t, char *, char *, char **);
extern int parse_time_cgivar(json_object *, time_t, char *, char *, time_t *);
extern int parse_boolean_cgivar(json_object *, time_t, char *, char *, int *);
extern int parse_int_cgivar(json_object *, time_t, char *, char *, int *);
