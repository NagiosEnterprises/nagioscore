...
extern int	nerd_mkchan(const char *name, const char *description,
						int (*handler) (int, void *), unsigned int callbacks);
...
extern int	qh_register_handler(const char *name, const char *description,
								unsigned int options, qh_handler handler);
...
int check_contact_service_notification_viability(contact *, service *, int, int, int);	/* checks viability of notifying a contact about a service */
...
int check_contact_host_notification_viability(contact *, host *, int, int, int); /* checks viability of notifying a contact about a host */
...
int add_notification(nagios_macros *mac, contact *, bool exclude);	/* adds a notification instance */
