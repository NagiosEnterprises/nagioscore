...
extern json_object *json_object_hostlist(unsigned, int, int, int, int, host *, int, host *,
...
extern json_object *json_object_servicecount(host *, int, host *, int, host *,
											 ...
											 char *, char *, contactgroup *, timeperiod *,
											 timeperiod *, command *, command *);
extern json_object *json_object_servicelist(unsigned, int, int, int, host *, int, host *, int,
											host *, hostgroup *, servicegroup *, contact *,
...
extern json_object *json_object_servicegrouplist(unsigned, int, int, int, service *);
extern json_object *json_object_servicegroup(unsigned, servicegroup *);
extern void json_object_servicegroup_details(json_object *, unsigned, servicegroup *);

extern json_object *json_object_contactcount(contactgroup *, timeperiod *, timeperiod *);
...
extern json_object *json_object_contactgrouplist(unsigned, int, int, int, contact *);
extern json_object *json_object_contactgroup(unsigned, contactgroup *);
extern void json_object_contactgroup_details(json_object *, unsigned, contactgroup *);
...
extern json_object *json_object_servicedependencylist(unsigned, int, int, host *, hostgroup *,
													  char *, servicegroup *, host *,
													  hostgroup *, char *, servicegroup *);
...
extern json_object *json_object_serviceescalationcount(host *, char *,
													   ...
													   contactgroup *);
extern json_object *json_object_serviceescalationlist(unsigned, int, int, host *, char *,
													  hostgroup *, servicegroup *, contact *,
													  contactgroup *);
extern void json_object_serviceescalation_details(json_object *, unsigned,
												  serviceescalation *);

extern json_object *json_object_hostdependencycount(host *, hostgroup *, host *, hostgroup *);
extern json_object *json_object_hostdependencylist(unsigned, int, int, host *,
												   hostgroup *, host *, hostgroup *);
extern void json_object_hostdependency_details(json_object *, unsigned, hostdependency *);
...
extern void json_object_hostescalation_details(json_object *, unsigned, hostescalation *);
