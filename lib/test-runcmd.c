...
struct {
	...
	" ", "\t", " ", NULL}}, {
		0, "\\$foo walla wonga", 3, {
	"$foo", "walla", "wonga", NULL}}, {
		0, "\"\\$bar is\" very wide open", 4, {
	"$bar is", "very", "wide", "open", NULL}}, {
		0, "VAR=VAL some command", 3, {
	"VAR=VAL", "some", "command", NULL}}, {
		RUNCMD_HAS_SHVAR, "VAR=VAL some use of $VAR", 5, {
	"VAR=VAL", "some", "use", "of", "$VAR", NULL}}, {
		RUNCMD_HAS_SHVAR, "VAR=$VAL some use of $VAR", 5, {
	"VAR=$VAL", "some", "use", "of", "$VAR", NULL}}, {
		RUNCMD_HAS_SHVAR | RUNCMD_HAS_WILDCARD, "VAR=\"$VAL\" a wilder\\ command*", 3, {
	"VAR=$VAL", "a", "wilder command*", NULL}}, {
		0, NULL, 0, {
NULL, NULL, NULL}},};
