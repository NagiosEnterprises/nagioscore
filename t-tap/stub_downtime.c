...
int cleanup_downtime_data(void) { return OK; }
int initialize_downtime_data(void) { return OK; }
void free_downtime_data(void) { return; }
...
int delete_host_downtime(unsigned long downtime_id) { return OK; }
int delete_service_downtime(unsigned long downtime_id) { return OK; }
int delete_downtime(int id, unsigned long downtime_id) { return OK; }


int register_downtime(int id, unsigned long downtime_id) { return OK; }
int handle_scheduled_downtime(struct scheduled_downtime *sd) { return OK; }

int is_host_in_pending_flex_downtime(struct host *hst) { return OK; }
int is_service_in_pending_flex_downtime(struct service *svc) { return OK; }
...
int sort_downtime(void) { return OK; }
