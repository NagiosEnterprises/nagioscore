...
int xodtemplate_get_contactgroup_names(xodtemplate_memberlist **,
									   xodtemplate_memberlist **, char *, int, int);
...
xodtemplate_daterange *xodtemplate_add_exception_to_timeperiod(xodtemplate_timeperiod *, int,
...
xodtemplate_customvariablesmember
	*xodtemplate_add_custom_variable_to_object(xodtemplate_customvariablesmember **, char *,
											   char *);
